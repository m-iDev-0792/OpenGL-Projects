...
/*		glActiveTexture(GL_TEXTURE0);
		...
		//设置材质
		glUniform3f(glGetUniformLocation(shaderProgram,"material.ambientColor"),0.19225f,0.19225f,0.19225f);
		glUniform3f(glGetUniformLocation(shaderProgram, "material.diffuseColor"),0.50754f,0.50754f,0.50754f);
		glUniform3f(glGetUniformLocation(shaderProgram, "material.specularColor"),0.508273f,0.508273f,0.508273f);
